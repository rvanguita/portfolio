...
- **M.S., Urban Infrastructure Systems** | Pontifícia Universidade Católica de Campinas (_2019_)
- **B.S., Electrical Engineering** | Pontifícia Universidade Católica de Campinas (_2016_)

## Projects

### Regression
- **[Wind Farm](https://github.com/rvanguita/wind_farm)**: Estimativa da curva de geração de um parque eólico offshore. Métodos baseados em árvores são utilizados devido à natureza não linear da curva.

### Classification
- **[Bank Customer Churn](https://github.com/rvanguita/bank_customer_churn)**: Projeto para prever a rotatividade de clientes com base em dados bancários.
